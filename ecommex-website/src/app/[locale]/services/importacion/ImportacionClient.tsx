...
const includedIcons = [Ship, FileCheck, Globe, Truck, ShieldCheck, FileText];
const processIcons = [Search, ClipboardList, Plane, CheckSquare, Warehouse];
// Icons for the "Servicios complementarios" related cards. Order must match
// services.importacion.related.items in the i18n JSON.
...
// (e.g. /services/importacion/why-0.jpg) once the photo shoot is delivered.
...
export function ImportacionClient() {
  const t = useTranslations('services.importacion');
