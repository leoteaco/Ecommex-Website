...
const includedIcons = [Package, Layers, Tag, Boxes, ScanLine, RefreshCw];
const processIcons = [ClipboardList, Box, Package, ShoppingBag, Truck];
// Icons for the "Servicios complementarios" related cards. Order must match
// services.fulfillment.related.items in the i18n JSON.
const relatedIcons = [Warehouse, Ship, Truck, RotateCcw];

// Temporary placeholder images for the "Why Ecommex" section. Swap with real photos
// once the photo shoot is delivered.
...
export function FulfillmentClient() {
  const t = useTranslations('services.fulfillment');
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-28 lg:px-8">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {[0, 1, 2, 3].map((i) => {
              ...
              const href = `/services/${slug}` as '/services/almacenamiento';
