...
const includedIcons = [Thermometer, Activity, Calendar, ScanLine, Sliders, Shield];
const processIcons = [Truck, ClipboardCheck, LayoutGrid, RefreshCw, PackageCheck];
// Icons for the "Servicios complementarios" related cards. Order must match
// services.almacenamiento.related.items in the i18n JSON.
const relatedIcons = [Package, Cpu, Ship, RotateCcw];

// Temporary placeholder images for the "Why Ecommex" section. Swap with real photos
// (e.g. /services/almacenamiento/why-0.jpg) once the photo shoot is delivered.
const whyEcommexImages = [
  '/services/warehouse.jpg',
  '/services/almacenamiento/racks.jpg',
  '/services/almacenamiento/secondary.jpg',
];

export function AlmacenamientoClient() {
  const t = useTranslations('services.almacenamiento');
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/services/almacenamiento/hero.jpg)',
      ...
      <section className="relative bg-navy-dark">
        <div className="relative h-[480px] md:h-[520px] overflow-hidden">
          <img
            src="/services/almacenamiento/secondary.jpg"
            alt=""
            className="absolute inset-0 h-full w-full object-cover"
          />
