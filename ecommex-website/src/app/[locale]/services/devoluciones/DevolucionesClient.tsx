...
const includedIcons = [PackageOpen, ClipboardCheck, RefreshCw, Wrench, Trash2, BarChart3];
const processIcons = [PackageOpen, FileSearch, Eye, Workflow, CheckCircle2];
// Icons for the "Servicios complementarios" related cards. Order must match
// services.devoluciones.related.items in the i18n JSON.
...
// (e.g. /services/devoluciones/why-0.jpg) once the photo shoot is delivered.
...
export function DevolucionesClient() {
  const t = useTranslations('services.devoluciones');
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-navy-dark flex flex-col min-h-[clamp(500px,70svh,800px)] lg:min-h-[840px]">
        ...
        >
          {/* TODO: replace with /services/devoluciones/hero.jpg when photo is ready */}
          <img
      ...
      <section className="relative bg-navy-dark">
        <div className="relative h-[480px] md:h-[520px] overflow-hidden">
          {/* TODO: replace with /services/devoluciones/secondary.jpg when photo is ready */}
          <img
            src="/services/warehouse.jpg"
            alt=""
            className="absolute inset-0 h-full w-full object-cover"
