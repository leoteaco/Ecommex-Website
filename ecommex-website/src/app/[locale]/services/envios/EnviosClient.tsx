...
const includedIcons = [Globe, Truck, DollarSign, MapPin, Wallet, Bell];
const processIcons = [Cpu, Tag, Package, Activity, CheckCircle2];
// Icons for the "Servicios complementarios" related cards. Order must match
// services.envios.related.items in the i18n JSON.
const relatedIcons = [Warehouse, Package, Ship, Cpu];
...
export function EnviosClient() {
  const t = useTranslations('services.envios');
